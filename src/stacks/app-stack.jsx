...
import ServiceRegisterScreen from '../screens/Service/register';
...
function AppNavigator() {
	...
	return (
		...
		>
			...
			<Stack.Screen name="ServiceRegister" options={{ title: 'Cadastro de Serviço' }} component={ServiceRegisterScreen} />
